> **Type:** Index (MOC) — **Scope:** Protocols — **Status:** Active
> **Part of:** [[index]]

# Protocols

How work on this repository is run: which process governs a change, where tasks live, and which
agents operate on the code.
...
- [[index]] — parent hub
- [[Decisions]] — a protocol change that alters the architecture ends up as an ADR
- [[Bugs]] — the bug registry these protocols feed
